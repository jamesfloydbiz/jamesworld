...
export const ROUTES = [
...

  {
    ...
    title: 'Writing',
    description:
      "James Floyd's essays, letters, and updates — mirrored from jamesfloyd.substack.com so search engines can find every post.",
    priority: 0.8,
    changefreq: 'daily',
    // Body content is dynamically generated by the prerender script from
    // src/data/substack-posts.json — see writingBody() in prerender.mjs.
    body: '__DYNAMIC_WRITING__',
  },
