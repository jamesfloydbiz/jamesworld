...
const META = {
  'state-of-american-schooling': {
    ...
    sections: [
      ...
      { name: 'Where they go to school',           date: '80% district' },
      { name: 'Governance and funding',            date: '$1T a year' },
      { name: 'Funding trends',                    date: '26x since 1920' },
      { name: 'School expenses and spending',      date: '79% people' },
      { name: 'Student academic performance',      date: 'PISA, TIMSS, PIRLS, PIAAC' },
      { name: 'The distribution of the losses',    date: 'what averages hide' },
      { name: 'Time in school',                    date: '20% of a childhood' },
      { name: 'Chronic absenteeism',               date: '22%' },
      { name: 'Teachers',                          date: '1 in 8 uncertified' },
      { name: 'Phonics',                           date: '2013 onward' },
      ...
      { name: 'Sources',                           date: '74 references' },
    ],
  },
  ...
  'learning-science': {
    ...
    sections: [
      ...
      { name: 'The Bundle Example: Direct Instruction',   date: '~0.5–0.6 SD' },
      { name: 'The important concept: Cognitive Load Theory', date: 'a framework' },
