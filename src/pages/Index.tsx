...
const Index = () => {
  ...
  return (
    <div className="fixed inset-0 bg-black">
      ...
      {/* Persistent top-right logo (only after loading) */}
      <AnimatePresence>
        {!showLoading && (
          <motion.div
            className="fixed top-6 right-6 z-40 w-12 h-12"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
