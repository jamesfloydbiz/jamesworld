...
const references: Reference[] = [
  // Row 1
  {
    ...
    quote:
      '"I\'ve got to know James Floyd over the past year and can vouch for his talent, creativity, work ethic, and connecting skills plus many more. I hope one of my partners in NYC finds this and gets a chance to work with you."',
    rotation: "-1.2deg",
  },
  {
    type: "text",
  ...
  // Row 2
  {
    ...
    quote:
      '"James you have been a major blessing to me and to the team and I know I\'m not the only one who shares that."',
    rotation: "2deg",
  },
  {
    type: "text",
  ...
  return (
    ...
    >
      <div className="border border-foreground/10 bg-background p-6 md:p-8 shadow-[0_2px_20px_-8px_hsl(var(--foreground)/0.08)]">
        <p className="text-foreground/80 italic text-base md:text-lg leading-relaxed font-light">{item.quote}</p>
