...
const LandmarkIcon = ({ id }: { id: string }) => {
  ...
  switch (id) {
    ...
    case 'projects':
      return (
        <g>
          ...
          <line x1={16} y1={-20} x2={16} y2={14} stroke="#3d3020" strokeWidth={sw} />
          <path d="M10 -8 L16 -16 L22 -8" fill="none" stroke="#3d3020" strokeWidth={sw} />
          <path d="M11 -2 L16 -10 L21 -2" fill="none" stroke="#3d3020" strokeWidth={sw} />
        </g>
      );
    case 'network':
      return (
    ...
    case 'blueprints':
      return (
        <g>
          <line x1={14} y1={-18} x2={14} y2={14} stroke="#3d3020" strokeWidth={2} />
          <line x1={11} y1={-4} x2={14} y2={-8} stroke="#3d3020" strokeWidth={0.8} />
          <rect x={-12} y={-10} width={20} height={24} rx={0} fill="none" stroke={stroke} strokeWidth={sw} />
          <circle cx={-2} cy={-10} r={2} fill="#8B6914" stroke="#8B6914" strokeWidth={0.5} />
...
const ElevationMarks = () => (
  <g fill="#2a2218" fontFamily="monospace" fontSize={6.25} opacity={0.35}>
...
/* ─── Ink border — dark ─── */
const MapBorder = () => (
  <g fill="none" stroke="#2a2218" opacity={0.5}>
