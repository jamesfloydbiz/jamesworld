...
The Bundle Example: Direct Instruction
...
An example of explicit instruction and high frequency response is my physics class from high school. To me, it felt like the entire 50 minute lecture was a conversation. She would define a concept and then ask us questions, have us explain it to our groups, then respond again to her prompts. This amount of interaction within the boundaries of the explicit definition helped walk the path of encoding and retrieval many times by the end of class.
...
The important concept: Cognitive Load Theory
