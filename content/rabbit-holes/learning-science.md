...
Recently, I've been reading up on a new kind of school called Alpha School. They claim their students learn twice as much twice as fast, so I decided to dive in. Is this actually possible?


This is an essay on learning science techniques that can be used in a school or learning environment to increase learning quality and speed. In fact, the reason I'm writing this is based on the way knowledge in one's brain is created.


When you're talking about history and someone quotes an author, or when you're cooking and need to do some math in your head, it becomes important to have actually learned. So first — how does information get into our brains where we can use it when we need it? How does learning work?


Put simply, learning goes through a few steps.


**Step 1: Information consumption.** This is when you read a book or blog post, listen to a song, talk to a friend, or see an advertisement.


**Step 2: Store it in working memory.** Your working memory is like the RAM on a computer, or your basket at the grocery store. It can only store a little bit, and only for a little while. Scientifically speaking, working memory holds about four units — you could remember F, C, N, M, or you could remember FBI, CIA, NBA, MLS. Both count as four chunks.


**Step 3: Encoding.** Once information is in working memory it can be encoded into long term memory. This is like saving a document to your computer or the cloud. It is also the transfer from your grocery basket to your fridge or pantry.
...
1. Worked examples with faded support

Working on real, complex problems with support, where the support fades slowly as you improve.
...
*Effect size ~0.4 SD average. Kluger & DeNisi 1996, meta-analysis — the same analysis found roughly one third of feedback interventions made performance worse.*


7. Tutoring

This one has some controversy. It certainly helps learning move faster; the question is how much faster. There was a paper published in 1984 by a man named Benjamin Bloom, and although his having a cool name is not up for debate, the findings are.
...
Having students explain why they got the answer, how they got it, why the material matters, and other such justifications.


My story takes me back to Bellevue, Washington, when I went to community college to test out that route. I had to take some general courses again, one of them Communications 101. In that class my teacher taught how people understand new information. He said there are two ways. The first is to assimilate new information into frameworks you already have — understanding basketball strategy through the lens of a different sport you played growing up. The second is accommodating: creating new frameworks to understand and store information. The reason is simple. It is more efficient to store frameworks and models, and then use those as cues to remember specific information.


Having a student explain themselves forces them to create connections, and therefore pathways, between different frameworks in their mind.


*Effect size g ~0.55. Bisra, Liu, Nesbit, Salimi & Winne 2018, meta-analysis of 69 effect sizes.*


9. Direct instruction

This is a bundle of techniques given one name, and I mention the bundle because of how effective it is. It includes the worked examples and feedback from above, along with explicit instruction and high frequency response.


Explicit instruction means defining the concept specifically, rather than working with the student so they discover it on their own. High frequency response is essentially how much students are responding to the teacher during teaching.


An example is my physics teacher in high school. To me it felt like the entire fifty minute lecture was a conversation. She would define a concept, ask us a question, have us explain it to our groups, then respond again to her prompts. That amount of interaction, inside the boundaries of an explicit definition, walked the path of encoding and retrieval many times over by the end of class.


*Effect size ~0.5–0.6 SD. Stockard, Wood, Coughlin & Rasplica Khoury 2018, meta-analysis covering fifty years of research; Project Follow Through.*
...
*No single effect size — cognitive load theory is a framework rather than one technique, and it explains why several of the above work. Specific predictions do have numbers; the split-attention effect is around 0.7. See Sweller 1988; Cowan 2001 on the four chunk limit.*


So, is 2x possible?

These techniques as a whole are why there is so much room to improve in education. People CAN learn faster, and these techniques are how. With all of these methods combined it is plausible to believe students can learn twice as fast and retain more of what they learn — especially if they are well motivated.
